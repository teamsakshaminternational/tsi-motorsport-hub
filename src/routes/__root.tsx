  ...
  head: () => ({
    meta: [
      ...
      { title: "Team Saksham International — Baja SAE, VIT Chennai" },
      {
        name: "description",
        content:
          "Team Saksham International is the Baja SAE team of VIT Chennai, designing and racing student-built off-road buggies.",
      },
      { name: "author", content: "Team Saksham International" },
